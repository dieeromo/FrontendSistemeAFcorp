...
export const listProductoAction = () => async (dispatch, getState) => {
    try {
        dispatch({ type: PRODUCTO_LIST_REQUEST })
        ...
        const { data } = await axios.get(RUTA_SERVIDOR + `/productos/list_producto/`, config);
